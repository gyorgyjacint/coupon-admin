...
const data: NotificationData[] = [
  {
    ...
    imgUrl:
      "https://phobiacures.info/blog/wp-content/uploads/2009/12/test-1024x1024.jpg",
    pushed: false,
    tags: ["tag1", "tag2", "tag3"],
  },
  {
    ...
    <SafeAreaView>
      ...
      >
        ...
        {modalData?.imgUrl != null && modalData?.imgUrl.length > 0 ? (
          <Image
            style={[styles.center, styles.imgLarge]}
            resizeMode="contain"
            source={{ uri: modalData.imgUrl }}
          />
        ) : (
          <Ionicons
            style={styles.center}
      ...
      <ScrollView>
        ...
        {data &&
          data.map((notification: NotificationData, i) => (
            <Pressable
              onPress={() =>
                handleModalOnPress({
                  setVisibility: setModalVisible,
            ...
            >
              <Card containerStyle={styles.card}>
                ...
                notification.imgUrl.length > 0 ? (
                  <Image
                    style={[styles.center, styles.imgSmall]}
                    resizeMode="contain"
                    source={{ uri: notification.imgUrl }}
                  />
                ) : (
                  <Ionicons
                    style={styles.center}
